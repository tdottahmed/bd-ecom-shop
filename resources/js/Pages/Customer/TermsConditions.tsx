        ...
        <div className="space-y-14">
            <section id="acceptance">
                ...
                <div className="prose-body">
                    <p>
                        Welcome to True by Malaysia. These Terms & Conditions
                        ("Terms") govern your access to and use of our website
                        located at <strong>truebymalaysia.com</strong> (the
                        "Platform") and all services, products, and content made
                        available through it.
                    </p>
                    <p>
                        By browsing our Platform, creating an account, or
                        placing an order, you confirm that you have read,
                        understood, and agree to be bound by these Terms. If you
                        do not agree to any part of these Terms, please
                        discontinue use of our Platform immediately.
                    </p>
                    <p>
                        These Terms apply to all users, including visitors,
                        customers, and any other party who accesses or uses the
                        Platform.
                    </p>
                </div>
            </section>
            ...
            <section id="use-of-site">
                ...
                <div className="prose-body">
                    ...
                    <ul>
                        <li>
                            Use the Platform in any way that violates applicable
                            local, national, or international laws or
                            regulations.
                        </li>
                        <li>
                            Engage in any conduct that is fraudulent, deceptive,
                            or misleading.
                        </li>
                        <li>
                            Attempt to gain unauthorised access to any part of
                            the Platform, its servers, or databases.
                        </li>
                        <li>
                        ...
                        <li>
                            Use automated tools to scrape, crawl, or extract
                            data from the Platform without prior written
                            consent.
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        any user who violates these terms, at our sole
            ...
            <section id="products">
                ...
                <div className="prose-body">
                    <p>
                        We take care to ensure that all product descriptions,
                        images, and specifications on the Platform are accurate
                        and up to date. However, we do not warrant that product
                        descriptions or other content is entirely error-free.
                    </p>
                    <p>
                        All prices displayed on the Platform are in{" "}
                        <strong>Malaysian Ringgit (MYR)</strong> and include
                        applicable taxes unless otherwise stated. Prices are
                        subject to change without prior notice. The price
                        applicable to your order will be the price displayed at
                        the time you place the order.
                    </p>
                    <p>
                        We reserve the right to modify or discontinue any
                        product at any time without notice. We shall not be
                        liable to you or any third party for any modification,
                        suspension, or discontinuation of a product.
                    </p>
                    <p>
                        In the case of a pricing error, we will contact you
                        before processing your order. You will have the option
                        to proceed at the correct price or cancel your order
                        without charge.
                    </p>
                </div>
            </section>
            ...
            <section id="orders">
                ...
                <div className="prose-body">
                    <p>
                        When you place an order through our Platform, you are
                        making an offer to purchase the selected products at the
                        stated price. An order is confirmed only after our team
                        has reviewed and accepted it — typically via a
                        confirmation call or message.
                    </p>
                    <p>
                        We currently operate exclusively on a{" "}
                        <strong>Cash on Delivery (COD)</strong> basis. Payment
                        is collected upon delivery of your order. No upfront
                        payment is required at the time of placing an order.
                    </p>
                    <p>
                        We reserve the right to refuse or cancel any order at
                        our discretion, including in cases of suspected fraud,
                        incorrect product information, or unavailability of
                        stock.
                    </p>
                    <p>
                        By placing an order, you confirm that all information
                        provided — including your name, phone number, and
            ...
            <section id="shipping">
                ...
                <div className="prose-body">
                    <p>
                        We aim to dispatch all confirmed orders within{" "}
                        <strong>1–2 business days</strong>. Estimated delivery
                        times vary depending on your location and courier
                        availability, but typically range from{" "}
                        <strong>2–5 business days</strong> from the date of
                        dispatch.
                    </p>
                    <p>
                        Delivery charges, if applicable, are calculated at
                        checkout based on your selected delivery area and will
                        be presented clearly before you confirm your order.
                    </p>
                    <p>
                        While we make every effort to meet estimated delivery
                        windows, we cannot guarantee specific delivery dates.
                        Delays may occur due to circumstances beyond our
                        control, including public holidays, adverse weather, or
                        courier disruptions.
                    </p>
                    <p>
                        Risk of loss and title for purchased items passes to you
                        upon delivery. If you have not received your order
                        within the estimated window, please contact our support
                        team and we will investigate promptly.
                    </p>
                    <p>
                        Currently, we only deliver within{" "}
                        <strong>Malaysia</strong>. We do not offer international
            ...
            <section id="returns">
                ...
                <div className="prose-body">
                    <p>
                        ...
                        purchase. If you are not happy with your order for any
                        reason, you may request a return within{" "}
                        <strong>14 days</strong> of receiving your item, subject
                    ...
                    <ul>
                        <li>
                            Items that are unopened, unused, and in their
                            original packaging.
                        </li>
                        <li>
                        ...
                        <li>
                            Items that are materially different from their
                    ...
                    <ul>
                        ...
                        <li>
                            Perishable goods, personal care products, or items
                    ...
                    <p>
                        ...
                        support team with your order number and a description of
                        the issue. We will review your request and provide
                        further instructions. Approved refunds will be processed
            ...
            <section id="ip">
                ...
                <div className="prose-body">
                    <p>
                        ...
                        to text, graphics, logos, product images, button icons,
                        audio clips, digital downloads, data compilations, and
                        software — is the property of True by Malaysia or its
                        content suppliers and is protected by applicable
                        intellectual property laws.
                    </p>
                    <p>
                        You are granted a limited, non-exclusive,
                        non-transferable licence to access and use the Platform
                        for personal, non-commercial purposes. This licence does
                        not permit you to:
                    </p>
                    <ul>
                        <li>
                            Reproduce, distribute, or publicly display any
                            content from the Platform without our prior written
                            consent.
                        </li>
                        <li>
                            Modify or create derivative works based on Platform
                            content.
                        </li>
                        <li>
                            Use any content for commercial purposes without our
                            express written authorisation.
                        </li>
                    </ul>
                    <p>
                        Any unauthorised use of the Platform's content may give
            ...
            <section id="liability">
                ...
                <div className="prose-body">
                    <p>
                        To the fullest extent permitted by applicable law, True
                        by Malaysia and its directors, employees, agents, and
                        affiliates shall not be liable for any indirect,
                        incidental, special, consequential, or punitive damages
                        arising from your use of the Platform or purchase of our
                        products.
                    </p>
                    <p>
                        Our total liability to you in connection with any claim
                        arising out of or related to these Terms or the products
                        purchased shall not exceed the total amount paid by you
                    ...
                    <p>
                        ...
                        negligence, fraud, or any other matter that cannot be
                        excluded by law.
                    </p>
                </div>
            </section>
            ...
            <section id="privacy">
                ...
                <div className="prose-body">
                    <p>
                        Your privacy matters to us. The collection, use, and
                    ...
                    <p>
                        By using our Platform, you consent to the collection and
                        use of your information as described in our Privacy
                        Policy. We encourage you to review the Privacy Policy
                        carefully before providing any personal information.
                    </p>
                </div>
            </section>
            ...
            <section id="governing-law">
                ...
                <div className="prose-body">
                    <p>
                        ...
                        <strong> Malaysia</strong>, without regard to its
                        conflict of law provisions.
                    </p>
                    <p>
                        Any dispute arising out of or in connection with these
                        Terms, including any question regarding their existence,
                        validity, or termination, shall be subject to the
            ...
            <section id="changes">
                ...
                <div className="prose-body">
                    <p>
                        ...
                        appropriate, notify you by email or a prominent notice
                        on the Platform.
                    </p>
                    <p>
                        Your continued use of the Platform after any changes to
                        these Terms constitutes your acceptance of the revised
            ...
            <section id="contact">
                ...
                <div className="prose-body">
                    <p>
                        ...
                        regarding these Terms & Conditions, please do not
            ...
            <div className="relative min-h-screen bg-gradient-to-b from-brand-ivory via-white to-slate-50">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-24">
                    ...
                    <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-12 items-start">
                        ...
                        <div
                            ref={contentRef}
                            className={hasContent ? "lg:col-span-2" : ""}
                        >
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 px-1">
                                <p className="text-xs text-slate-400 text-center sm:text-left">
                                    These terms were last reviewed and updated
                                    on {LAST_UPDATED}.
                                </p>
